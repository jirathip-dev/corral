...
loopback daemon with real TLS via Tailscale Serve: see "Remote access
from iOS (Tailscale Serve)" in docs/OPERATIONS.md.) Use a throwaway config dir for the first run — the
